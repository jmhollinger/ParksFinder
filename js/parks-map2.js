...
var parks = new google.maps.Data();
var pools = new google.maps.Data();
var golfcourses = new google.maps.Data();
var communitycenters = new google.maps.Data();

parks.loadGeoJson('data/parks-data.geojson');
pools.loadGeoJson('data/x.geojson');
golfcourses.loadGeoJson('data/x.geojson');
communitycenters.loadGeoJson('data/x.geojson');
  ...
  parks.setStyle(style1);
  
  var infowindow = new google.maps.InfoWindow();

  parks.data.addListener('click', function(event) {
      ...
      infowindow.setContent(
        ...
        '<ul class="feature-list">' + pavedtrails + playground + dogpark + discgolf + shelter + openfields + 
        baseball + basketball + football + horseshoes + tennis + volleyball + bldg + restroom + '</ul></div>'
        );
